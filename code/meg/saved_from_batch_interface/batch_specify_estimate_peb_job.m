%-----------------------------------------------------------------------
% Job saved on 10-Nov-2022 16:33:59 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
...
%%
matlabbatch{1}.spm.dcm.spec.meeg.dcmmat = {'/imaging/henson/Wakeman/cognestic22_multimodal_dcm/fits/batch_gui/meg/templates/DCMs/DCM_Full.mat'};
...
matlabbatch{1}.spm.dcm.spec.meeg.dir = {'/imaging/henson/Wakeman/cognestic22_multimodal_dcm/fits/batch_gui/meg/templates/GCMs/Full'};
...
matlabbatch{2}.spm.dcm.estimate.output.single.dir = {'/imaging/henson/Wakeman/cognestic22_multimodal_dcm/fits/batch_gui/meg'};
