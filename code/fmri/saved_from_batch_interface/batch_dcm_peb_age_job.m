%-----------------------------------------------------------------------
% Job saved on 25-Jan-2024 21:38:06 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7771)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.spm.dcm.peb.specify.name = 'Age';
matlabbatch{1}.spm.dcm.peb.specify.model_space_mat = {'/imaging/henson/Wakeman/pranay_does_things/CBU_Neuroimaging_2024_Test_Reset/fits/batch_gui/fmri/GCM_Full.mat'};
matlabbatch{1}.spm.dcm.peb.specify.dcm.index = 1;
matlabbatch{1}.spm.dcm.peb.specify.cov.regressor.name = 'Age';
%%
matlabbatch{1}.spm.dcm.peb.specify.cov.regressor.value = [4.6
                                                          -1.4
                                                          3.6
                                                          -0.4
                                                          -3.4
